...
namespace PLA.CE
{
    class ProjectileFlyingDroneCE : ProjectileGuidedBulletCE
    {
        ...
        public override void Draw()
        {
            ...
            Vector3 position = new Vector3(this.ExactPosition.x, this.def.Altitude - 0.01f, this.ExactPosition.z - Mathf.Lerp(this.shotHeight, 0f, this.get_fTicks() / this.startingTicksToImpact));
